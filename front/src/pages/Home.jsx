...
export default function Home() {
  ...
  useEffect(() => {
    if (location.state?.notification) {
      ...
      const timer = setTimeout(() => setNotification(null), 3500); // 3.5초 후 알림 제거
...
useEffect(() => {
  ...
  return (
    <>
      ...
      {notification && (
        <Notification
          message={notification} // 메시지 전달
          onClose={() => setNotification(null)} // 닫기 핸들러 전달
        />
      )}
      <TodoModal
